...
CREATE TABLE `areas`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `index_areaid`(`areaid`) USING BTREE,
...
CREATE TABLE `cities`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `index_cityId`(`cityid`) USING BTREE
...
-- ----------------------------
-- Table structure for cold_chain_car
-- ----------------------------
DROP TABLE IF EXISTS `cold_chain_car`;
CREATE TABLE `cold_chain_car`  (
  `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `tem` float NULL DEFAULT 0,
  `hum` float NULL DEFAULT 0,
  `cur_weight` float NULL DEFAULT 0,
  `weight` float NULL DEFAULT 0,
  `cur_volume` float NULL DEFAULT 0,
  `volume` float NULL DEFAULT 0,
...
-- ----------------------------
DROP TABLE IF EXISTS `cold_chain_center`;
CREATE TABLE `cold_chain_center`  (
  `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `area_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `delivery`  (
  ...
  `car_dri_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `goods`  (
  ...
  `tem` float NULL DEFAULT NULL,
  `hum` float NULL DEFAULT NULL,
  `price` float NULL DEFAULT NULL,
  `goods_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `status` tinyint(4) NULL DEFAULT NULL,
...
INSERT INTO `goods` VALUES ('gs8cfa08bfxd', '蘑菇', 0, 0, 2, 100, 30, 'https://baise212lz.oss-cn-chengdu.aliyuncs.com/logistics/2025/2/3/a5fa2cbdb8f3489ca27576f71ba4583f.jpg', 5, '654516865');
INSERT INTO `goods` VALUES ('gs9832bd99x5', '苹果', 8, 1500, -2, 6, 5, 'https://baise212lz.oss-cn-chengdu.aliyuncs.com/logistics/2025/1/15/0d07c23dcddf453e8d870bda99d07e2d.jpg', 3, '202111345');
INSERT INTO `goods` VALUES ('gsa3dcb6b7xf', '雪梨', 3, 1000, -3, 2, 5, 'https://baise212lz.oss-cn-chengdu.aliyuncs.com/logistics/2025/1/16/6e69257bbe1940c8a82c4a9f9dca7dbf.jpg', 4, '202111389');
INSERT INTO `goods` VALUES ('gsaf834288x6', '甘甜的芒果【平果芒果】', 0, 0, 10, 85, 7.5, 'https://baise212lz.oss-cn-chengdu.aliyuncs.com/logistics/2025/2/3/ce18889f32c54914b47992069dd6496c.jpg', 5, '202114586');
INSERT INTO `goods` VALUES ('gsb6f32baax6', '鲜猪肉【好品质好生活】', 5, 5000, -2, -4, 12, 'https://baise212lz.oss-cn-chengdu.aliyuncs.com/logistics/2025/1/22/b6671fe9aeee4176abe69a3c5e633fb9.jpg', 3, '202111654');
INSERT INTO `goods` VALUES ('gsbf97e8bfxd', '芒果', 6, 1000, -2, -5, 3, 'https://baise212lz.oss-cn-chengdu.aliyuncs.com/logistics/2025/1/21/f195e3220e5647d48615391032c951d6.jpg', 4, '202111389');
INSERT INTO `goods` VALUES ('gscfd6f8ffxc', '茄子X', 0, 0, -3, 10, 3.5, 'https://baise212lz.oss-cn-chengdu.aliyuncs.com/logistics/2025/1/16/2ba1ebfaa92e48b9a7149910507d1885.jpg', 5, '202111345');
INSERT INTO `goods` VALUES ('gsd1fd6f7axf', '橘子', 0, 0, -1, 6, 4.5, 'https://baise212lz.oss-cn-chengdu.aliyuncs.com/logistics/2025/1/15/f95a2ca76afd411cb172b2406e1b7e28.jpg', 5, '202111389');
INSERT INTO `goods` VALUES ('gsd1fsdfsaxf', '石榴', 0, 0, -2, 4, 3, 'https://t14.baidu.com/it/u=2369814202,2038257782&fm=224&app=112&f=JPEG', 5, '654516865');

-- ----------------------------
-- Table structure for goods_cost
-- ----------------------------
DROP TABLE IF EXISTS `goods_cost`;
CREATE TABLE `goods_cost`  (
  `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `buyer_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `sales_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `deli_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `cost` float NOT NULL,
  `status` tinyint(4) NULL DEFAULT NULL,
  `updateTime` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES (1, 1, '首页', '/mainUser', 'MainUser', 'HomeFilled', 0, '1');
INSERT INTO `menu` VALUES (2, 1, '首页', '/mainAdmin', 'MainAdmin', 'HomeFilled', 0, '0');
INSERT INTO `menu` VALUES (3, 2, '个人中心', '/person', 'Person', 'Avatar', 0, '0,1');
INSERT INTO `menu` VALUES (4, 1, '基本资料', '/person/info', '/person/Info', NULL, 3, '0,1');
INSERT INTO `menu` VALUES (5, 1, '用户管理', '/userManage', 'UserManage', 'UserFilled', 0, '0');
...
-- Records of money
-- ----------------------------
INSERT INTO `money` VALUES (1, '202111345', '6222356612412045571', 0);
INSERT INTO `money` VALUES (2, '202111389', '6222356612412045599', 6750);
INSERT INTO `money` VALUES (3, '202111478', '6222356612412045571', 0);
INSERT INTO `money` VALUES (4, '202111654', '6222356612412045571', 0);
INSERT INTO `money` VALUES (5, '202111856', '6222356612412045571', 0);
INSERT INTO `money` VALUES (6, '202111965', '6222356612412045571', 0);
...
CREATE TABLE `payment_record`  (
  ...
  `collect_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `cost` float NOT NULL,
  `pay_type` tinyint(4) NULL DEFAULT NULL,
  `transaction` tinyint(4) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `payment_record` VALUES (2, '202168484', '202111389', 6750, 2, 1, 'gca2a45583xf', '2025-01-31 20:49:31');
INSERT INTO `payment_record` VALUES (7, '202111389', '123456', 700, 1, 2, 'rcde8925f9x5', '2025-01-31 21:09:50');
INSERT INTO `payment_record` VALUES (8, '654516865', '202114586', 3750, 1, 1, 'gc23cdec38xc', '2025-02-03 14:22:04');
INSERT INTO `payment_record` VALUES (12, '202114586', '128970', 340, 2, 2, 'rcad2626eax6', '2025-02-03 15:41:36');
INSERT INTO `payment_record` VALUES (16, '202114586', '202114586', 3410, 2, 3, '', '2025-02-03 17:16:04');
INSERT INTO `payment_record` VALUES (17, '128970', '128970', 340, 2, 3, '', '2025-02-03 17:24:00');
INSERT INTO `payment_record` VALUES (18, '2020898989', '654516865', 30000, 1, 1, 'gcf8f2880bx2', '2025-02-03 21:54:37');
INSERT INTO `payment_record` VALUES (20, '654516865', '128970', 430, 2, 2, 'rcb6d282ddx5', '2025-02-03 22:03:17');
INSERT INTO `payment_record` VALUES (21, '654516865', '654516865', 29570, 2, 3, '', '2025-02-03 22:04:17');
INSERT INTO `payment_record` VALUES (22, '654516865', '128970', 325, 1, 2, 'rccacf8031x6', '2025-02-04 12:26:26');
...
CREATE TABLE `provinces`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `index_privinceId`(`provinceid`) USING BTREE
...
-- ----------------------------
-- Table structure for refrigerate_room
-- ----------------------------
DROP TABLE IF EXISTS `refrigerate_room`;
CREATE TABLE `refrigerate_room`  (
  `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `tem` float NULL DEFAULT 0,
  `hum` float NULL DEFAULT 0,
  `cur_volume` float NULL DEFAULT 0,
  `max_volume` float NULL DEFAULT 0,
  `status` tinyint(4) NOT NULL,
  `ccc_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `createTime` date NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of refrigerate_room
-- ----------------------------
INSERT INTO `refrigerate_room` VALUES ('rm1001', '冷链室1号', -3, 4, 9, 100, 2, 'ccc1001', '2025-01-13');
...
INSERT INTO `room_cost` VALUES ('rcde8925f9x5', '202111389', 'de3917695cx2', 3, 700, 2, '2025-02-01 13:52:03');

-- ----------------------------
-- Table structure for room_cost_compute
-- ----------------------------
DROP TABLE IF EXISTS `room_cost_compute`;
CREATE TABLE `room_cost_compute`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `volumePrice` float NULL DEFAULT NULL,
  `weightPrice` float NULL DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `room_goods`;
CREATE TABLE `room_goods`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `rm_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `goods_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `status` tinyint(4) NULL DEFAULT NULL,
  `createTime` datetime(0) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `room_goods` VALUES (2, 'rm1001', 'gs36ff2c77x1', 1, '2025-01-14 00:00:00');
INSERT INTO `room_goods` VALUES (5, 'rm1001', 'gsb6f32baax6', 1, '2025-01-23 00:00:00');
INSERT INTO `room_goods` VALUES (6, 'rm1002', 'gsa3dcb6b7xf', 1, '2025-01-23 00:00:00');
INSERT INTO `room_goods` VALUES (8, 'rm1002', 'gsbf97e8bfxd', 1, '2025-01-23 00:00:00');
INSERT INTO `room_goods` VALUES (9, 'rm1002', 'gs81077e10x2', 1, '2025-01-23 00:00:00');
INSERT INTO `room_goods` VALUES (11, 'rm1003', 'gs9832bd99x5', 1, '2025-01-25 00:00:00');
INSERT INTO `room_goods` VALUES (12, 'rm1001', 'gscfd6f8ffxc', 2, '2025-01-23 00:00:00');
INSERT INTO `room_goods` VALUES (13, 'rm1002', 'gsd1fd6f7axf', 2, '2025-01-23 00:00:00');
...
-- ----------------------------
INSERT INTO `transportation` VALUES ('ts0630f1a0xa', '202168484', 'gs79e2d546x5', '第十三届东方五百', 1, '2025-01-25 18:29:03', '');
...
INSERT INTO `transportation` VALUES ('ts8d9f8f7axd', '202111389', 'gsa3dcb6b7xf', '长江大街附院区', 3, '2025-01-23 15:21:15', 'tc1738405ax4');
INSERT INTO `transportation` VALUES ('ts9ec9bc3cx9', '202111654', 'gsb6f32baax6', '弄头村12号', 3, '2025-01-23 15:08:03', 'tc5584b639xf');
INSERT INTO `transportation` VALUES ('tsca5c42a9x8', '654516865', 'gsd1fsdfsaxf', '局烈村22号', 3, '2025-02-04 12:21:05', 'tcc5492862xc');

-- ----------------------------
-- Table structure for ts_car
-- ----------------------------
DROP TABLE IF EXISTS `ts_car`;
CREATE TABLE `ts_car`  (
  `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
